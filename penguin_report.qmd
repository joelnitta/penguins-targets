...
The models that did account for species shows the opposite result: a positive relationship between bill length and depth for each species (@fig-separate-plot).
